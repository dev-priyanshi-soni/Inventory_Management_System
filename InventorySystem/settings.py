...
SECRET_KEY = 'django-insecure-6w%u_r$u(xegqb_ne=ix+@m%-hj8j&a8io*g&@13-9)hm6^_1h'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            'level': 'DEBUG',  # This means all logs at DEBUG and above will be captured
    ...
    'loggers': {
        'django': {
            'handlers': ['file'],
            'level': 'DEBUG',  # Log all messages at DEBUG and above
            'propagate': True,
        },
        'your_app_name': {  # Change this to your actual app name
            'handlers': ['file'],
            'level': 'DEBUG',  # Log all messages at DEBUG and above
            'propagate': False,
        },
